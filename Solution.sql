CREATE DATABASE IF NOT EXISTS jayakumar_jfs_053;

USE jayakumar_jfs_053; 

#Creating the table
CREATE TABLE IF NOT EXISTS students_informations (
    id INT,
    first_name CHAR(100),
    last_name CHAR(100),
    age INT
...
INSERT INTO students_information(id,first_name,last_name,age) VALUES (101,'Jay','kumar',23);
INSERT INTO students_information(id,first_name,last_name,age) VALUES (102,'Surya','Yadav',20);  

INSERT INTO students_information VALUES (103,'Umesh','Mudhiraj',20);
INSERT INTO students_information VALUES (104,'Anand','Kumar',23);

INSERT INTO students_information(id,first_name,last_name,age) VALUES (105,'Naveen','Kumar',21);
INSERT INTO students_information(id,first_name,last_name,age) VALUES (106,'Sweety','Reddy',24);

INSERT INTO students_information(first_name,last_name) VALUES ('Neha','chowdary');
INSERT INTO students_information(id,age) VALUES (108,25);

SELECT id,first_name,last_name,age FROM students_informations;

# Exercise-2: Employee Details.

# Creating the table
CREATE TABLE IF NOT EXISTS employee_detailss(
    id INT,
    name CHAR(100),
    joining_date DATE,
    department CHAR(100),
...
#Inserting fields and records into the table.
INSERT INTO employee_details(id,name,joining_date,department,salary) VALUES (201,' Mouni' ,'2025-01-01','HR',55000);
INSERT INTO employee_details(id,name,joining_date,department,salary) VALUES (202,'Kishore','2024-08-20','Finance',40000);

INSERT INTO employee_details VALUES (203,'Thrisha','2020-05-10','IT',9090000);
INSERT INTO employee_details VALUES (204,'Charitha','2019-11-25','Marketing',330000);

INSERT INTO employee_details(id,name,joining_date,department,salary) VALUES (205,'Vamc','2023-02-12','Sales',123000), (206,'Harsha','2022-07-18','Support',36000);

INSERT INTO employee_details VALUES (207,'Sai Kumar','2021-09-09','Admin',32000), (208,'Divya bharathi','2020-12-01','IT',60000);

INSERT INTO employee_details(id,name) VALUES (209,'Tejeswani');
...
# Creating the table
CREATE TABLE IF NOT EXISTS product_catalogg (
    id INT,
    name CHAR(100),
    category CHAR(100),
    price INT
...
# Creating the table.
CREATE TABLE IF NOT EXISTS stationaryy (
    id INT,
    title CHAR(100),
    author CHAR(100),
...
# Inserting fields and records into the table.
INSERT INTO movie_collection(id,name,language,release_year) VALUES (501,'Pushpa2','Telugu',2022);
